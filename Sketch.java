...
public class Sketch extends PApplet {
  ...
  public void draw_section3(){
    ...
    for(int intRow = 0; intRow < 300; intRow+=10){
      for(int intColumn = 0; intColumn <= 300; intColumn+=10){
        if(intColumn % 4 == 0){
        intX = 600 + 3 + intRow;  //Instead of zero, calculate the proper intX location using 'intRow'
        intY = 300 + 3 + intColumn; //Instead of zero, calculate the proper intY location using 'intColumn'
        fill(0);
        noStroke();
        rect(intX, intY, 5, 5);
  ...
  public void draw_section5(){
    ...
    for(int intRow = 0; intRow <= 300; intRow+=10){
      for(int intColumn = 0; intColumn <= intRow; intColumn+=10){
        intX = 3 + intRow;  //Instead of zero, calculate the proper intX location using 'intRow'
        intY = 297 - 3 - intColumn; //Instead of zero, calculate the proper intY location using 'intColumn'
        fill(255);
        noStroke();
        rect(intX, intY, 5, 5);
  ...
  public void draw_section6(){
    ...
    for(int intRow = 0; intRow <= 300; intRow+=10){
      for(int intColumn = 0; intColumn < intRow; intColumn+=10){
        intX = 606 - 3 - intRow;  //Instead of zero, calculate the proper intX location using 'intRow'
        intY = 297- 3 - intColumn; //Instead of zero, calculate the proper intY location using 'intColumn'
        fill(255);
        noStroke();
        rect(intX, intY, 5, 5);
  ...
  public void draw_section7(){
    ...
    for(int intRow = 0; intRow < 300; intRow+=10){
      for(int intColumn = 0; intColumn < 300 - intRow; intColumn+=10){
        intX = 600 + 3 + intRow;  //Instead of zero, calculate the proper intX location using 'intRow'
